...
class AnsiStandardLib {
  ...
  static const ansiEraseInDisplayAll = controlSequenceIdentifier + '2J';
  static const ansiEraseInLineAll = controlSequenceIdentifier + '2K';
  static const ansiEraseCursorToEnd = controlSequenceIdentifier + 'K';
  static const ansiHideCursor = controlSequenceIdentifier + '?25l';
  static const ansiShowCursor = controlSequenceIdentifier + '?25h';
  static const ansiCursorLeft = controlSequenceIdentifier + 'D';
  static const ansiCursorRight = controlSequenceIdentifier + 'C';
  static const ansiCursorUp = controlSequenceIdentifier + 'A';
  static const ansiCursorDown = controlSequenceIdentifier + 'B';
