...
void main() {
  ...
  print(
    'Window dimensions LTRB: (${bufferInfo.srWindow.Left}, ${bufferInfo.srWindow.Top}, ${bufferInfo.srWindow.Right}, ${bufferInfo.srWindow.Bottom})',
  );
  print(
    'Cursor position X/Y: (${bufferInfo.dwCursorPosition.X}, ${bufferInfo.dwCursorPosition.Y})',
  );
  print(
    'Window size X/Y: (${bufferInfo.dwSize.X}, ${bufferInfo.dwSize.Y})',
  );
  print(
    'Maximum window size X/Y: (${bufferInfo.dwMaximumWindowSize.X}, ${bufferInfo.dwMaximumWindowSize.Y})',
  );
